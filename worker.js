...
console.log("worker: Generating the sample data");
const songBuffer = zzfxM(...songData); // Generate the sample data
console.log("worker: Done, sample data generated");
postMessage({right: new Float32Array(songBuffer[0]), left: new Float32Array(songBuffer[1])});
